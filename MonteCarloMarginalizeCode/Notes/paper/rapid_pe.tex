...
\begin{abstract}
We present a method for rapid, parallelizable parameter estimation 
of GWs from CBCs.
\end{abstract}
\maketitle
...
\item Methods
	...
	\item Integration over extrinsic parameters
		\begin{itemize}
		\item Do a basic Monte Carlo integral over remaining extrinsic parameter.
...
Citations: Bayesian methods and monte carlo integration \cite{2011RvMP...83..943V}; comparison to other PE for LIGO
