...
Unless otherwise stated, we adopted nonspinning TaylorT4 templates; 
used roughly $200$ mass points for each event, distributed on spokes in $\mc,\eta$ radiating away from the reported
