...
# namespace with CondorDAG/CondorDAGNode/CondorDAGJob/CondorDAGManJob classes
# that work under either the htcondor python bindings or, as a fallback, the
# legacy glue.pipeline interface.
